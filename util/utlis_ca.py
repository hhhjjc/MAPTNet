...
def get_base_lr_params(model):
    base_b = []
    base_b.append(model.module.layer2.parameters())
    base_b.append(model.module.layer3.parameters())
    for j in range(len(base_b)):
        for i in base_b[j]:
            yield i
...
def get_10x_lr_params(model):
    ...
    b.append(model.module.FPM_Decoder.layer55.parameters())
    b.append(model.module.FPM_Decoder.layer6_0.parameters())
    b.append(model.module.FPM_Decoder.layer6_1.parameters())
    b.append(model.module.FPM_Decoder.layer6_2.parameters())
    b.append(model.module.FPM_Decoder.layer6_3.parameters())
    b.append(model.module.FPM_Decoder.layer6_4.parameters())
    b.append(model.module.FPM_Decoder.layer7.parameters())
    b.append(model.module.FPM_Decoder.layer9.parameters())
    b.append(model.module.FPM_Decoder.supp_residule1.parameters())
    b.append(model.module.FPM_Decoder.residule1.parameters())
    b.append(model.module.FPM_Decoder.residule2.parameters())
    b.append(model.module.FPM_Decoder.residule3.parameters())
